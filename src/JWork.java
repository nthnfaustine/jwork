...
//
        ...
        try {
            DatabaseBonus.addBonus(new Bonus(DatabaseBonus.getLastId() + 1, "abcd", 10, 1, false));
        } catch (ReferralCodeAlreadyExistsException e) {
            e.printStackTrace();
        }
//
...
//        System.out.println(DatabaseBonus.getBonusDatabase());
        ...
        try {
            DatabaseInvoice.addInvoice(new EwalletPayment(10, myJob, DatabaseJobSeeker.getJobseekerById(1), DatabaseBonus.getBonusById(1)));
        } catch (JobSeekerNotFoundException | OngoingInvoiceAlreadyExistsException | BonusNotFoundException e) {
            System.out.println(e.getMessage());
        }

        try {
            DatabaseInvoice.addInvoice(new EwalletPayment(13, myJob, DatabaseJobSeeker.getJobseekerById(2), DatabaseBonus.getBonusById(1)));
        } catch (JobSeekerNotFoundException | OngoingInvoiceAlreadyExistsException | BonusNotFoundException e) {
            System.out.println(e.getMessage());
        }

        try {
            DatabaseInvoice.addInvoice(new EwalletPayment(14, myJob, DatabaseJobSeeker.getJobseekerById(3), DatabaseBonus.getBonusById(1)));
